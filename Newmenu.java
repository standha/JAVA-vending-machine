...
public Newmenu() {
   ...
   JLabel lbl3 = new JLabel("변경 이름 입력:");
   ...
   //버튼 생성
    ...
    JButton change=new JButton("메뉴 이름 변경");
   ...
   p.add(change);     //변경 버튼 추가
    ...
    change.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
           ...
           String s1=txt3.getText();                  // 바꿀 메뉴    
           int i=Integer.valueOf(txt2.getText());     // 메뉴 번호
